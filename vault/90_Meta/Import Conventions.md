...
Rules: do not put Context phrases into Tags; do not invent free-form tags; AI must not infer Tags from Raw Thought / Context. Empty Tags omit the footer line (no `## Tags` section, no YAML `tags:`).
